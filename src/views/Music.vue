    ...
    <van-row class="head">
      ...
      <van-col span="16" class="two-van-col">
        <div class="center_font">
          ...
          <span>{{this.information.ar[0].name}}</span>
        </div>
      </van-col>
...
// 
      ...
      changeHome() {
        ...
        //音乐播放地址
        this.$refs.playMusic.src = "https://music.163.com/song/media/outer/url?id=" + this.information.id +".mp3"
    ...
    created() {
		...
		// console.log(Params)
		console.log("zcy",this.$store.state.music)
		...
		//设置当前歌曲时间
		this.time = Math.round(this.information.dt / 1000)
